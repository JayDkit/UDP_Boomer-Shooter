...
namespace GDApp
{
    public class Main : Game
    {
        ...
        public void InitializeLevel()
        {
            ...
            turret = new GameObject("Turret1",GameObjectType.NPC);
            StandardTurret turret1Script = new StandardTurret();
            turret.AddComponent(turret1Script);
            turret1Script.bulletPrefab = bulletPrefab;
            turret.Transform.SetTranslation(-20f,1.1f,-20f);
            turret.Transform.SetScale(new Vector3(1, 1, 1));
            turret1Script.InitializeModel();
            level1.Add(turret);
        ...
        private void InitializeCameras(Scene level)
        {
            ...
            */
            ...
            camera.AddComponent(new FPSController(0.5f, 0.3f, 0.006f, 60f));
